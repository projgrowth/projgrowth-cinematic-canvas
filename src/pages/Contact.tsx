        ...
        <div className="mt-20 py-16 border-t border-line">
          <form className="grid-12 gap-y-6">
            <div className="col-span-12 lg:col-span-6">
              ...
              <input 
                type="text"
                className="w-full px-4 py-3 bg-surface border border-line rounded-md text-text placeholder:text-mute focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 shadow-inner transition-all duration-sm ease-smooth"
            ...
            <div className="col-span-12">
              ...
              <textarea 
                rows={6}
                className="w-full px-4 py-3 bg-surface border border-line rounded-md text-text placeholder:text-mute focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/20 shadow-inner transition-all duration-sm ease-smooth resize-none"
