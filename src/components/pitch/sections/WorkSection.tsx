...
const CARDS: Card[] = [
  {
    ...
    body: "Built the format, identity, drops, invites, inside jokes, and recap rhythm that made people want in.",
    rgc: "For RGC: build the room before the event.",
    featured: true,
  },
  {
    ...
    body: "Built the operating system for prep, recording, post, approval, asset delivery, and publishing.",
    rgc: "For RGC: turn moments into media and follow-up.",
    featured: true,
  },
  {
    ...
    body: "Built a real-time customizer and turned customer designs into content, retention, and referrals.",
    rgc: "For RGC: make drops personal enough to carry themselves.",
  },
  {
    title: "Designed premium hospitality",
    role: "04 · premium hospitality",
    proof: "HNW guests · custom gear · concierge details",
    body: "Designed a high-touch trip where every guest felt known before arrival: invites, food, gear, and details built around them.",
    rgc: "For RGC: make premium trips feel hosted and worth paying up for.",
  },
  {
    title: "Hosted golf as a relationship engine",
    role: "05 · event revenue",
    proof: "25 clients · 18th-hole hospitality · referral momentum",
    body: "Produced a golf hospitality day that made relationships warmer, more social, and easier to extend.",
    rgc: "For RGC: make events create relationships and repeat demand.",
  },
  {
    title: "Made boring work feel cultural",
    role: "06 · earned attention",
    proof: "24 reels/month · wearable merch · referrals doubled",
    body: "Built a content engine in a category with almost no cultural oxygen — and made people follow, share, wear, and refer.",
      ...
      <div className="pitch-grid relative z-10">
        <div className="pitch-grid__main">
          ...
          <p className="section-intro">
            Not a logo wall. Receipts for the pieces RGC is hiring around:
            community, content, drops, premium events, lifecycle, and earned
            attention.
          </p>
